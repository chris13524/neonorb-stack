...
!function ($) {
    ...
    TabCollapse.DEFAULTS = {
        ...
        accordionTemplate: function(heading, groupId, parentId, active) {
            return  '<div class="card">' +
                    '   <div class="card-header js-tabcollapse-card-header">' +
                    '   </div>' +
                    '   <div id="' + groupId + '" class="card-block collapse ' + (active ? 'in' : '') + '">' +
                    '       <div class="card-text js-tabcollapse-card-text">' +
                    '       </div>' +
                    '   </div>' +
                    '</div>'
    ...
    TabCollapse.prototype.showTabs = function(){
        ...
        var $panelHeadings = this.$accordion.find('.js-tabcollapse-card-header').detach();
        ...
        var $panelBodies = this.$accordion.find('.js-tabcollapse-card-text');
    ...
    TabCollapse.prototype.showAccordion = function(){
        ...
        if(this.options.updateLinks) {
            ...
            var $selector = this.$accordion.find('.js-tabcollapse-card-text');
    ...
    TabCollapse.prototype._tabHeadingToPanelHeading = function($heading, groupId, parentId, active) {
        $heading.addClass('js-tabcollapse-card-header ' + (active ? '' : 'collapsed'));
        $heading.attr({
            'data-toggle': 'collapse',
            'data-parent': '#' + parentId,
            'href': '#' + groupId
    ...
    TabCollapse.prototype._initAccordion = function(){
        ...
        this.$accordion = $('<div class="cards ' + this.options.accordionClass + '" id="' + accordionId +'"></div>');
    ...
    TabCollapse.prototype._createAccordionGroup = function(parentId, $heading){
        ...
        $panel.find('.card-header').append(this._tabHeadingToPanelHeading($heading, groupId, parentId, active));
        $panel.find('.card-text').append($tabPane.contents().detach())
